...
from agent_safety.core.budget_override import (
    OverrideRequest,
    OverrideStatus,
    OverrideType,
)
from agent_safety.core.dynamic_budget import (
    AgentBudgetProfile,
    AgentPriority,
    BudgetPool,
)
from agent_safety.core.transaction import (
    TransactionContext,
    TransactionError,
    TransactionManager,
    Transactional,
...
class BudgetCoordinator(Transactional[BudgetState]):
    ...
    def _execute_direct_transfer(self, request: TransferRequest) -> None:
        ...
        target_pool_id = max(
            target_pools,
            key=lambda pid: self._shared_pools[pid].priority.value
